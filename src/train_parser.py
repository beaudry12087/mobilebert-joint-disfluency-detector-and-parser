...
def run_self_attentive_parser(run_config_filename, model_path=None, eval_out_path=None, evalb_dir=None):
	random_config = dict()
...
if __name__ == '__main__':
	run_self_attentive_parser(args.config, args.model_path, args.eval_path, args.evalb_dir)
